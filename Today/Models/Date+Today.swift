...
extension Date {
    ...
    var dayAndTimeText: String {
        /* NOT
         ...
         Sistem, varsayılan bir stil kullanarak geçerli yerel ayar için tarih ve saatin dize gösterimini biçimlendirir. Tarih stili için .omid ifadesinin
         geçirilmesi, yalnızca zaman bileşeninden
         oluşan bir dize oluşturur.*/

        let timeText = formatted(date: .omitted, time: .shortened)
        /*
         Uygulamanız, geçerli takvim günü için planlanan hatırlatıcılar için bir hatırlatıcının tarihini "Bugün saat 15:00" olarak görüntüleyerek aciliyet
         duygusu verecektir. Hatırlatıcının tarihi geçerli takvim gününden başka bir şeyse, "22 Ekim saat 15:00" gibi bir dize kullanacaksınız.
         
         Bu tarihin geçerli takvim gününde olup olmadığını test eden bir if-else ifadesi ekleyin. */
        if Locale.current.calendar.isDateInToday(self) {
            /* Ardından, dünyanın dört bir yanındaki kullanıcılarınız için dizenin "Bugün at" bölümünü yerelleştireceksiniz. Uygulamanıza, her dize ve çevirisi
            için bir giriş içeren bir çeviri tablosu ekleyeceksiniz.
            ...
            /* Daha sonra, sağlanan tarih geçerli takvim tarihinde olmadığında biçimlendirilmiş bir dize oluşturmak için Foundation çerçevesindeki
             formatted(date:time:) komutunu kullanacaksınız.
            ...
            /* Tarih ve saat metnine dateAndTimeFormat uygulayarak bir dize oluşturun ve sonucu döndürün.
             Hesaplanan mülkünüz artık yerel ayarlara duyarlı bir biçimde tarih ve saati temsil ediyor. */
              ...
              // NOT: Biçimlendirilmiş dizenin döndürülmesi derleyici hatasını düzeltir.
                   /* Yalnızca tarihin biçimlendirilmiş ve yerelleştirilmiş dize temsilini döndüren dayText adında başka bir hesaplanmış özellik oluşturun.
                    Ardından aşağıdaki adımlarda özel tarih biçimi içeren bir çözüme bakın.
